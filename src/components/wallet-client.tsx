            ...
            <Dialog open={isDepositOpen} onOpenChange={setDepositOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Enter the amount you wish to deposit. You will be redirected to Pay Changu to complete the payment.
                  </DialogDescription>
                </DialogHeader>
            ...
            <Dialog open={isWithdrawOpen} onOpenChange={setWithdrawOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Enter the amount you wish to withdraw. Funds will be sent to your registered payment method.
                  </DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-4 items-center gap-4">
