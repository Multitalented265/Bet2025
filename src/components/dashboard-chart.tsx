...
export function DashboardChart({ candidates, totalPot }: DashboardChartProps) {
  ...
  // Mobile should scroll vertically; desktop shows full list without internal scroll
  ...
  return (
    <Card className="w-full shadow-lg">
      ...
      <CardContent>
        {/* Mobile: vertical scroll within the card */}
        ...
        {/* Desktop and up: no internal scroll */}
